...
: public GCW::Dbo::BaseItem< Item >
{
  public:
    ...
    const std::string & account_guid    () const { return m_account_guid    ; }
    const std::string & memo            () const { return m_memo            ; }
    const std::string & action          () const { return m_action          ; }
    const std::string & reconcile_state () const { return m_reconcile_state ; }
    const std::string & reconcile_date  () const { return m_reconcile_date  ; }
          int           value_num       () const { return m_value_num       ; }
